...
#ifndef GOOGLEMAP_SWIFT_H
#define GOOGLEMAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GoogleMap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9GoogleMap11AppDelegate")
...
SWIFT_CLASS("_TtC9GoogleMap17MapViewController")
...
@interface MapViewController (SWIFT_EXTENSION(GoogleMap)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC9GoogleMap13SceneDelegate")
...
SWIFT_CLASS("_TtC9GoogleMap14ViewController")
